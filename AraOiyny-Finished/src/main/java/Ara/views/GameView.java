...
import Ara.components.Beehive;
import Ara.components.BeehiveCell;
import Ara.controllers.GameController;
import Ara.core.constants.Colors;
import Ara.core.constants.UINames;
...
public class GameView extends View {
    ...
    private void assignEvents() {
        ...
        model.getResultWordProperty().addListener((o, n, t) -> {
            String str = String.format("%s (%d ұпай)", model.getResultWordPropertyValue(), model.getPointPropertyValue());
