...
import Ara.core.constants.Messages;
import Ara.core.data.DataFilter;
import Ara.core.data.DataReader;
import Ara.core.data.FilteredData;
...
public class GameCreatorManager implements GameCreatorService {
    ...
    private final String KAZAKH_LETTERS = "аәбвгғдежзийкқлмнңоөпрстуұүфхһцчшщъыіьэюя";
    ...
    private void checkIllegalLetter(String letters) throws IllegalLetterException {
        boolean contains;
        String alphabet = KAZAKH_LETTERS;
        for (int i = 0; i < letters.length(); i++) {
            contains = false;
